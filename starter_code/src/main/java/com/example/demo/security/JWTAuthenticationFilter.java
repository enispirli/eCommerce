...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            ...
            log.error("Authentication attempt error: ", e.getMessage());
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        log.info("User {} authenticated, JWT token created", ((User) auth.getPrincipal()).getUsername());
    }
    ...
    protected void unsuccessfulAuthentication(javax.servlet.http.HttpServletRequest request,
        ...
        log.error("Authentication attempt error. {}.", failed.getMessage());
